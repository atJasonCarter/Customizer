...
// List of known 1-hour email service domains
var oneHourEmailDomains = ["0-mail.com",
"027168.com",
"0815.ru",
"0815.ry",
"0815.su",
...
// Get the email input and the CTA button
var emailInput = document.getElementById("bb-email");
var ctaButton = document.getElementById("bb-button");

// Function to validate email and enable/disable CTA button
function validateEmail() {
  var email = emailInput.value.trim();

  // Check if the email is valid and not from a 1-hour email service
  if (emailPattern.test(email) && !isOneHourEmail(email)) {
    ctaButton.classList.remove("innactive");
    emailInput.setCustomValidity("");
  } else {
    ctaButton.classList.add("innactive");
    emailInput.setCustomValidity("Use a valid, permanent email");
  }
}

// Function to check if email is from a 1-hour email service
function isOneHourEmail(email) {
  var domain = email.split("@")[1].toLowerCase();
  return oneHourEmailDomains.includes(domain);
}

// Event listener for input change
emailInput.addEventListener("input", validateEmail);
ctaButton.addEventListener("click", function(event) {
  if (ctaButton.classList.contains("innactive")) {
